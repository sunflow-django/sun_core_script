...
env_file = find_env_file(current_dir, warn_on_missing=True)
if env_file:
    load_dotenv(env_file)


def parse_cors(v: str | list) -> list[str] | str:
    """Parse either a string or a list for CORS."""
...
class Settings(BaseSettings):
    ...
    EMAIL_SUPERUSER_EMAIL: EmailStr = "test@example.com"
